          ...
          <HStack spacing={3}>
            ...
            <Box>
              <Heading size="lg" color={headingColor} fontWeight="bold">
                Gestión de Envíos de Insumos
              </Heading>
              <Text fontSize="sm" color={textColor}>
                Visualiza y administra los envíos de insumos realizados
              </Text>
            </Box>
          </HStack>
          ...
          <Box>
            {isMobile ? (
              <IconButton
                ...
                aria-label="Agregar Envío de Insumos"
                icon={<FiPlus />}
                colorScheme="green"
                size={buttonSize}
                borderRadius="lg"
      ...
      <Box maxW="8xl" mx="auto">
        ...
        >
          <CardBody p={0}>
            ...
            {/* Table */}
            <Box>
              <TableExportsSent windowSize={windowSize} width={tableWidth} />
            </Box>
          </CardBody>
        </Card>
      </Box>
