...
import TableVerifiers from '../../../../components/verifier/table-verifier/TableVerifiers';
...
function VerifiersPage(): React.JSX.Element {
        ...
        >
          <HStack spacing={3}>
            ...
            <Box>
              ...
              <Text fontSize="sm" color={textColor}>
                Visualiza y administra las verificadoras registradas
              </Text>
            </Box>
          </HStack>
          ...
          <Box>
            {isMobile ? (
              <IconButton
                as={Link_Next}
                href="/dashboard/box-brands/add-verifier"
                aria-label="Agregar Verificadora"
                icon={<FiPlus />}
                colorScheme="green"
                size={buttonSize}
                borderRadius="lg"
      ...
      <Box maxW="8xl" mx="auto">
        ...
        >
          <CardBody p={0}>
            ...
            <Box>
              <TableVerifiers windowSize={windowSize} width={tableWidth} />
            </Box>
          </CardBody>
        </Card>
      </Box>
...
export default IsOnboarding(VerifiersPage);
