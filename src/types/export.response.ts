...
export interface BoxBrandResponse {
    ...
    miniPalletsType: { id: number; name: string; code: string; exporterId: number };
    miniPalletsTypeQuantity: number;
    cornerType: { id: number; name: string; code: string; exporterId: number };
    cornerTypeQuantity: number;
    reinforcementType: { id: number; name: string; code: string; exporterId: number };
    ...
    packingTapeType: { id: number; name: string; code: string; exporterId: number };
