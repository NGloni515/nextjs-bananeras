...
import InputFieldSecurityKitSelect from './InputFieldSecurityKitSelect';
...
const SecurityKitSelectBanContainer: React.FC<props> = ({
  name1,
  label1,
  placeholder1,
  name2,
...
export default SecurityKitSelectBanContainer;
